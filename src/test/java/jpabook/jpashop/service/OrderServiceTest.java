...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("시궁쥐", 10000, 10);
        ...
        assertEquals(OrderStatus.ORDER, getOrder.getStatus(), "상품 주문시 상태는 ORDER 이어야 합니다.");
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("시궁쥐", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("박영철");
        member.setAddress(new Address("서울", "을지로", "123-844"));
        em.persist(member);
        return member;
    }
}